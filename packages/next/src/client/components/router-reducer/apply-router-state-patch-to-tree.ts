...
function applyPatch(
  ...
  // however, there are scenarios where this behavior is undesired, such as when a server action is invoked
  // on a default segment. `applyPatchToDefaultSegment` is used to control this behavior
  if (
